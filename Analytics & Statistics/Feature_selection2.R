...
p1<-predict(rf88,test)
p1
confusionMatrix(p1,test$class)    # 67.74%
baruta
...
p2<-predict(rf50,test)
confusionMatrix(p2,test$class)
getConfirmedFormula(baruta)
rf37<-randomForest(class~V2+V3+V5+V8+V11+V14+V15+V20+V24+V25+V26+V35+V37+V40+V41+V42+V43+V47+V49+V50+V52+V53+V55+V57+V58+V59+V60+V66+V68+V70+V72+V79+V83+V84+V86+V87+V88,data=train)
p3<-predict(rf37,test)
